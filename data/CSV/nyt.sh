...
#curl https://data.cityofnewyork.us/api/views/a5td-mswe/rows.csv -o 2018.csv
#curl https://data.cityofnewyork.us/api/views/2bnn-yakx/rows.csv -o 2017.csv
#curl https://data.cityofnewyork.us/api/views/kiv2-tbus/rows.csv -o 2016.csv
#curl https://data.cityofnewyork.us/api/views/c284-tqph/rows.csv -o 2015.csv
#curl https://data.cityofnewyork.us/api/views/jt7v-77mi/rows.csv -o 2014.csv
